...
class CUDALLAMAAccelerator(Accelerator):
    """ This is the Distributed Accelerator specifically for Llama,
...
AcceleratorFactory.regist("cuda-llama", CUDALLAMAAccelerator)
