...
from flashmodels.patch import patch_amp, patch_gemma, patch_llama, patch_peft
...
def parse():
    ...
    parser.add_argument(
        "--tp_num", type=int, default=1, help="Tensor Parallel Number")
    parser.add_argument(
        "--sp",
        action="store_true",
        default=False,
    ...
    parser.add_argument(
        ...
        help="DeepSpeed Ulysses Sequence \
         Parallel Number. ")
    parser.add_argument(
        "--dp_num", type=int, default=1, help="Data Parallel Number")
    parser.add_argument(
        "--pp_num", type=int, default=1, help="Pipeline Parallel Number")
    parser.add_argument(
        "--fp16", action="store_true", help="Run model in fp16 mode.")
    parser.add_argument(
        "--bf16", action="store_true", help="Run model in bfloat16 mode.")
    parser.add_argument(
        "--force_use_syncfree_adam",
        action="store_true",
        help="Force to use \
    ...
    parser.add_argument(
        "--lora_r", type=int, default=8, help="lora attention dimension")
    parser.add_argument(
        "--lora_alpha",
        type=int,
        default=8,
    ...
    parser.add_argument(
        "--profile", action="store_true", help="Open pytorch profiler")
